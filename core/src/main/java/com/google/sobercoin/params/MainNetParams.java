...
public class MainNetParams extends NetworkParameters {
    public MainNetParams() {
        ...
        genesisBlock.setTime(1516430466L);
        genesisBlock.setNonce(2085408349L);
        genesisBlock.setMerkleRoot(new Sha256Hash("3cb665f9fa29646c830d00b81f238071c53dc7182c599252a8ca874d1600a52c"));

        id = ID_MAINNET;
        subsidyDecreaseBlockCount = 840000;
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("0f0b27509b9a2795d51575a68a05ecc3131a402396ca0e50965c334ada6a2912"),
                genesisHash);
