...
import com.google.sobercoin.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.google.sobercoin.core.Wallet.SendRequest)}.
