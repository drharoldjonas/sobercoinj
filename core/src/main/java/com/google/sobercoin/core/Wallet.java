...
package com.google.sobercoin.core;

import com.google.sobercoin.wallet.DefaultRiskAnalysis;
import com.google.sobercoin.wallet.RiskAnalysis;
import com.google.sobercoin.core.TransactionConfidence.ConfidenceType;
import com.google.sobercoin.core.WalletTransaction.Pool;
import com.google.sobercoin.crypto.KeyCrypter;
import com.google.sobercoin.crypto.KeyCrypterException;
import com.google.sobercoin.crypto.KeyCrypterScrypt;
import com.google.sobercoin.script.Script;
import com.google.sobercoin.script.ScriptBuilder;
import com.google.sobercoin.script.ScriptChunk;
import com.google.sobercoin.store.UnreadableWalletException;
import com.google.sobercoin.store.WalletProtobufSerializer;
import com.google.sobercoin.utils.ListenerRegistration;
import com.google.sobercoin.utils.Threading;
import com.google.sobercoin.wallet.*;
...
import org.sobercoinj.wallet.Protos.Wallet.EncryptionType;
...
import static com.google.sobercoin.core.Utils.bitcoinValueToFriendlyString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.sobercoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.sobercoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.sobercoin.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.sobercoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.sobercoin.wallet.WalletFiles.Listener)}
     ...
     * of {@link com.google.sobercoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.sobercoin.crypto.KeyCrypter,
     ...
     * {@link com.google.sobercoin.crypto.KeyCrypterScrypt}.
     *
        ...
        try {
            ...
            for (ECKey key : keychain) {
                if (key.isEncrypted()) {
                    ...
                    // (all sobercoin controlled by that private key is lost forever).
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.sobercoin.crypto.KeyCrypter,
     ...
     * you can use {@link com.google.sobercoin.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.sobercoin.core.TransactionBroadcaster broadcaster) {
        lock.lock();
        try {
