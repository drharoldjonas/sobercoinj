...
public abstract class Message implements Serializable {
    ...
    /**
     * Serialize this message to a byte array that conforms to the sobercoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the sobercoin wire format.
     *
     * @param stream
     * @throws IOException
     */
