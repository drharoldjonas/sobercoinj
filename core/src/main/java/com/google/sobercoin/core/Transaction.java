...
public class Transaction extends ChildMessage implements Serializable {
    ...
    // These are serialized in both sobercoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.sobercoin.script.Script, ECKey, com.google.sobercoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.sobercoin.core.Transaction.SigHash, boolean)}
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.sobercoin.it/wiki/Contracts
     ...
     * This is useful in certain types of <a href="http://en.sobercoin.it/wiki/Contracts">contracts</a>, such as
