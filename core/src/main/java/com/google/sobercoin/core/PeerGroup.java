...
import com.google.sobercoin.core.Peer.PeerHandler;
import com.google.sobercoin.discovery.PeerDiscovery;
import com.google.sobercoin.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService implements TransactionBroadcaster {
    ...
    // pipeline with the sobercoin serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.sobercoin.it/wiki/BIP_0014">BIP 14</a>.
     *
...
*/            // Link the peer to the memory pool so broadcast transactions have their confidence levels updated.
     ...
     * peers. By using this with {@link com.google.sobercoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.sobercoin.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.sobercoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.sobercoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.sobercoin.core.Peer#ping()}.
     */
