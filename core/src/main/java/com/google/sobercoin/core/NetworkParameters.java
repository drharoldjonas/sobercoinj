...
import com.google.sobercoin.params.TestNet2Params;
import com.google.sobercoin.params.TestNet3Params;
import com.google.sobercoin.params.UnitTestParams;
import com.google.sobercoin.script.Script;
import com.google.sobercoin.script.ScriptOpCodes;
...
import static com.google.sobercoin.core.Utils.COIN;
...
public abstract class NetworkParameters implements Serializable {
    ...
    public static final String ID_MAINNET = "org.sobercoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.sobercoin.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.sobercoin.unittest";
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.google.sobercoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.google.sobercoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.google.sobercoin.core.AlertMessage}s. You can use {@link com.google.sobercoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
