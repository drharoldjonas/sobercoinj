...
package com.google.sobercoin.discovery;

import com.google.sobercoin.core.AddressFormatException;
import com.google.sobercoin.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#sobercoin" or "#bitcoinTEST3" for the production and test networks
     *                respectively.
     */
