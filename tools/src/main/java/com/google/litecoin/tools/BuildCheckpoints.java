...
public class BuildCheckpoints {
    public static void main(String[] args) throws Exception {
        ...
        final FileOutputStream fileOutputStream = new FileOutputStream("sobercoin-checkpoints", false);
        ...
        CheckpointManager manager = new CheckpointManager(params, new FileInputStream("sobercoin-checkpoints"));
